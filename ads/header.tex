...
\newcommand{\setpagestylehead}{%
    \fancypagestyle{plain}{%
        ...
        \fancyhead[R]{
            ...
            \iflang{de}{
				\begin{textblock*}{188mm}(-8mm,9mm)            	
                    \includegraphics[height=1.2cm]{images/dhbw_de}
            	\end{textblock*}
            	}
            \iflang{en}{
            	\begin{textblock*}{188mm}(-8mm,7mm)            	
...
\fancypagestyle{plain}{%
        ...
        \fancyhead[R]{
            ...
            \iflang{en}{
                \begin{textblock*}{188mm}(-8mm,7mm)            	
                    \includegraphics[height=1.4cm]{images/dhbw_en}
                \end{textblock*}
                }
        }
        \fancyfoot[L]{
...
\fancypagestyle{plain}{%
        ...
        \fancyhead[R]{
            ...
            \iflang{de}{
                \begin{textblock*}{188mm}(-8mm,9mm)            	
                \includegraphics[height=1.6cm]{images/dhbw_de}
                \end{textblock*}
                }
            \iflang{en}{
                \begin{textblock*}{188mm}(-8mm,7mm)            	
                \includegraphics[height=1.6cm]{images/dhbw_en}
                \end{textblock*}
                }
        }
        \fancyfoot[L]{
